...
- **Amended by the owner on 2026-09-25** ([11-italian-content.md](11-italian-content.md)): the official Italian SRD PDF is not available, so the translation is drafted from the English with the glossary and online references for the terms, each recorded; no OCR step. The translation depends on srd51 by id, not at the exact version, with a coverage check. Its first packet (what the wizard shows) moves to M1.4r.
