...
- **Information pages** (owner, 2026-09-25): `/roadmap` (what exists, what comes next and later, in plain words), `/credits` (the author first, with "Buy me a beer" to https://buymeacoffee.com/byloth; the game content credited from the packages' manifests; trademarks; data, fonts and tools; the AGPL-3.0 licence) and `/privacy`, linked from the footer, in English and Italian.
